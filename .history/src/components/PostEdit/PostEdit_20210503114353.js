          ...
          {(formik) => (
            <div>
              ...
              <Form className="form-edit" onSubmit={handleUpdateProduct} >
                <TextField label="Title post: " name="title" type="text" size="40" ref={node => (titleRef = node)} />
                <TextField variant="textarea" rows="5" cols="40" label="Post description: " name="body" type="text"ref={node => (bodyRef = node)} />
                <TextField label="Author: " name="author" type="text" size="40" ref={node => (authorRef = node)} />
                <TextField label="Photo (URL): " name="photo" type="text" size="40" ref={node => (photoRef = node)}/>
